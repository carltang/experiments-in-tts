import os
import sys
from single_train_h5_trichar_dlstm import do_train
import numpy as np

logFile = "train_results_trichar_dlstm.txt"
...
#路径参数
input_path = 'dnn_train_data_trichar'
...
for dict_file in h5_list:
	hanzi = dict_file[-6]
	if type == 0:
		os.system("python single_train_h5_trichar_dlstm.py {} {}".format(hanzi, logFile))
	else:
